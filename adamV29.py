"""
ADAM — Autonomous Desktop AI Module (v29)
==========================================
...
def _draw_preview(data: dict) -> np.ndarray:
    ...
    cv2.putText(frame, "ADAM v29  [Q=close]", (8, 20),
...
def main_entry() -> None:
    ...
    print("=" * 66)
    print("  ADAM — Autonomous Desktop AI Module  (v29)")
    ...
    _ddg_status = "✅ ready — free web search + cache active" if DDG_AVAILABLE else "⚠️  not installed (pip install duckduckgo-search)"
    ...
    print("=" * 66)
    print()
    print("  HOW TO USE (v29 — DDG search + thresholded grounding):")
    ...
    print("  ⑦ Ask for news/weather       →  DDG (free, cached) used first;")
    print("                                   Google grounding fires only at threshold 0.75")
    if neck_ok:
