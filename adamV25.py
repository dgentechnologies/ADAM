"""
ADAM — Autonomous Desktop AI Module (v25)
==========================================
Works with the new single system_prompt.txt (compact, token-optimised).
No other prompt files needed.

CHANGES FROM v24:
  • Integrated adam_neck_serial.py — physical MG995 x2 servo neck control via Arduino Uno.
  • Added move_neck() tool declaration — Gemini can now call it to physically move head.
  • set_emotion() now auto-drives physical head movement via emotion_move().
  • Camera face-tracking pans physical head toward active speaker automatically.
  • init_neck() called at startup with auto COM port detection.
  • clean shutdown calls close_neck() in finally block.
  • Banner updated to v25.
...
def main_entry():
    ...
    print("=" * 66)
    print("  ADAM — Autonomous Desktop AI Module  (v25)")
